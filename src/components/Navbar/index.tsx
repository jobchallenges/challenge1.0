        ...
        <nav>
          <div className=" flex flex-row justify-between">
            <div className=" flex space-x-3 items-center">
              <svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor">
              ...
              <h1 className="font-normal text-2xl leading-6 text-gray-800">Challenge 1.0</h1>
            </div>
          </div>
        </nav>
      </div>
